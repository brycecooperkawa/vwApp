...
class FocusSquare: SCNNode {
    ...
    var lastPosition: SIMD3<Float>? {
        ...
        case .detecting(let raycastResult, _): return SIMD3(raycastResult.worldTransform.columns.3.x,raycastResult.worldTransform.columns.3.y,raycastResult.worldTransform.columns.3.z)
        }
    }
    ...
    func setPosition(with raycastResult: ARRaycastResult, _ camera: ARCamera?) {
        let position =  SIMD3(raycastResult.worldTransform.columns.3.x,raycastResult.worldTransform.columns.3.y,raycastResult.worldTransform.columns.3.z)
    ...
    func updateOrientation(basedOn raycastResult: ARRaycastResult) {
        self.simdOrientation = simd_quaternion(raycastResult.worldTransform)
    }
    ...
    private func scaleBasedOnDistance(camera: ARCamera?) -> Float {
        ...
        let distanceFromCamera = simd_length(simdWorldPosition - SIMD3(camera.transform.columns.3.x,camera.transform.columns.3.y,camera.transform.columns.3.z))
